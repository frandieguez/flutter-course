...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/montserrat.ttf
  String get montserrat => 'assets/fonts/montserrat.ttf';

  /// List of all assets
  List<String> get values => [montserrat];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [hogwarts, hpBackground];
}
